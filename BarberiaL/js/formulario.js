...
var metFormulario = {
	...
	inicio: function () {
		for (var i = 0; i < propFormulario.elementos.length; i++) {
			...
			if( propFormulario.elementos[i].type == 'text' || propFormulario.elementos[i].type == 'email' || propFormulario.elementos[i].type == 'date' || propFormulario.elementos[i].nodeName.toLowerCase() == 'textarea' ){
